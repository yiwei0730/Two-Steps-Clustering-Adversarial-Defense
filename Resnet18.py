...
def ResNet18(pre_train=False):
    if pre_train:
        return PretrainResNet(num_classes=10, num_layers=18)
    return ResNet(BasicBlock, num_blocks = [2,2,2,2], num_classes=10)
def ResNet50():
    return ResNet(BasicBlock, num_blocks = [3, 4, 6, 3], num_classes = 10)
